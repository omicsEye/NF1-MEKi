...
scatter_plot_1 <- ggplot(data=combined_data,aes(`Mice 2 Hrs coef`, `Mice 12 Hrs coef`, label = feature)) +
  xlab("Effect size of mice 2 hourse of MEKi treatment") + ylab("Effect size of mice 12 hourse of MEKi treatment")+
...
fig_scatters
ggsave(filename='manuscript/figures/Figure_2/fig_scatters_manuscript_format.pdf',
       plot=fig_scatters, width = 7.2, height = 2.5, units = "in", dpi = 350)
ggsave(filename='manuscript/figures/Figure_2/fig_scatters_presentation_format.png',
